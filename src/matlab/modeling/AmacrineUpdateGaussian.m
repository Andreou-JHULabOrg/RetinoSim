function [ threshold_on_update, threshold_off_update, loss_on, loss_off ] = AmacrineUpdateGaussian(...
    learning_rate, ...
    epc, ...
    isi, ...
    ideal, ...
...
if amacrine_spread.mode == 2
    [ threshold_on_update, threshold_off_update ] = AmacrineSpread( threshold_on_update, threshold_off_update, amacrine_spread.size, amacrine_spread.std );
end
